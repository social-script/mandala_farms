      ...
      <section className="container mx-auto px-4 py-8 md:py-16">
        <div className="grid grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-col gap-6 md:gap-8">
            {/* Top card */}
            <div className="relative rounded-[2rem] md:rounded-[2.5rem] overflow-hidden h-[240px] md:h-[280px] bg-[#2F4538] p-6 md:p-10 group">
              ...
              <div className="max-w-[85%]">
                <p className="font-poppins text-white/70 text-xs md:text-sm leading-relaxed mb-3 md:mb-4">
              ...
              <button className="absolute top-6 md:top-10 right-6 md:right-10 p-3 md:p-4 bg-white/10 rounded-full hover:bg-white/20 transition-all">
                <ArrowRight className="w-5 h-5 md:w-6 md:h-6 text-white" />
              </button>
            </div>
